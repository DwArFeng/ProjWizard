 ...
 * @since 0.0.1-alpha
 */
public abstract class ProjWizMenuBar extends JMenuBar {

	private static final long serialVersionUID = 4609742652443185451L;
	 ...
	 *            国际化接口。
	 */
	public ProjWizMenuBar(GuiManager guiManager, I18nHandler i18nHandler) {
