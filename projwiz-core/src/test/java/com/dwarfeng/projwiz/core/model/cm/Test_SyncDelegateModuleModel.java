...
public class Test_SyncDelegateModuleModel {
	...
	private static final class TestSetObverser implements SetObverser<Module> {
		...
		@Override
		public void fireAdded(Module module) {
			addedList.add(module);
		}
		...
		@Override
		public void fireRemoved(Module module) {
			removedList.add(module);
		}
	...
	private static SyncModuleModel model;
	private static TestSetObverser obv;

	@Before
	public void setUp() throws Exception {
		model = ModelUtil.syncModuleModel(
				new DefaultModuleModel(new LinkedHashMap<>(), Collections.newSetFromMap(new WeakHashMap<>())));
